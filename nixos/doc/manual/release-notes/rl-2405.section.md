...
- `services.k3s` now has a `registries` parameter, for configuring [private registries](https://docs.k3s.io/installation/private-registry) or [distributed image mirroring](https://docs.k3s.io/installation/registry-mirror).
